...
/*   -timeout_msec: Timeout time (in mili-secs) for receiving the data  */
/*                                                                       */
/* OUTPUT:                                                               */
/*   -data: The serial data received within the timeout_msec time        */
/*                                                                       */
/* RETURNS:                                                              */
...
//    } while (count<size && ret==1);
      /* MODIFICACIÓN PARA USO DE ARCHIVOS */
      } while (count<size && ret==1 && n>0);
